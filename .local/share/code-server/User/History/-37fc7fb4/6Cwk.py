...
def ask(question: str) -> str:
    ...
    response = client.chat.completions.create(
        ...
        temperature=0.3, #temperature in LLM related to creativity of the answer returned by LLM whose input values ranging from 0-2 where 0-0.3 is less creative , 0.4-0.9 - medium creative , 1-2 is highly creative
    )
