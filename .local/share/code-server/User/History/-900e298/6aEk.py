...
Run (from the repo root):uvicorn practice_examples.week03.streaming_demo:app --reload --port 8002

Then Run curl -s --no-buffer -X POST localhost:8002/ask  -H 'Content-Type:applic
ation/json' -d '{"question":"dummy question"}'
